...
namespace EEANWorks.WinFormsApps.AIDEL_IMS_Reports.Data
{
    ...
    public sealed class DataContainer
    {
        ...
        public SharePointConnectionManager SharePointConnectionManager_EvaluationFiles { get; private set; }
        ...
        {
            SharePointConnectionManager = null;
            SharePointConnectionManager_EvaluationFiles = null;
            ...
            if (tmp.CheckConnection() && tmp_evaluationFiles.CheckConnection())
            {
                SharePointConnectionManager = tmp;
                SharePointConnectionManager_EvaluationFiles = tmp_evaluationFiles;
                return true;
            }
