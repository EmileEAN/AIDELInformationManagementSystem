...
namespace EEANWorks.WinFormsApps.AIDELInformationManagementSystem.Data
{
    ...
    {
        public CustomSharePointConnectionManager(string _siteUrl, string _docLibrary, string _defaultSubFolderPath, string _username, string _password) : base(_siteUrl, _docLibrary, _username, _password, _defaultSubFolderPath)
        {
        }
