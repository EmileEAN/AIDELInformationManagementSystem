...
namespace EEANWorks.WinFormsApps.AIDEL_IMS_Registration
{
    ...
    public abstract class IberoCommunityMember : Person
    {
        ...
        public IberoCommunityMember(FullName _name,
                            string _organizationEmail) : base(_name, "", "")
        {
            OrganizationEmail = _organizationEmail;
        }
        public IberoCommunityMember(FullName _name,
                            int _accountNumber, string _organizationEmail) : base(_name, "", "")
        {
            AccountNumber = _accountNumber;
    ...
    public class Student : IberoCommunityMember
    {
        ...
        public Student(int _accountNumber, FullName _name, string _organizationEmail) : base(_name, _organizationEmail)
        {
        }
    }
    ...
    {
        public NonIberoCommunityMember(FullName _name,
                            int _personalId) : base(_name)
        {
            PersonalId = _personalId;
        }
        public NonIberoCommunityMember(FullName _name, string _email) : base(_name, _email, "")
        {
        }
        public NonIberoCommunityMember(FullName _name, string _email,
                            int _personalId) : base(_name, _email, "")
        {
            PersonalId = _personalId;
        }
        public NonIberoCommunityMember(FullName _name, string _email, string _phone,
                                    int _personalId) : base(_name, _email, _phone)
        {
            PersonalId = _personalId;
        }
        ...
        public string Email { get { return PreferredEmail; } set { PreferredEmail = value; } }
    }
}
