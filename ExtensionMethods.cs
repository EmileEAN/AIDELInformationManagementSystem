...
namespace EEANWorks
{
    ...
    {
        public static bool EqualsIgnoringCase(this string _string, string _targetString) { return _string.Equals(_targetString, StringComparison.OrdinalIgnoreCase); }

        public static bool Contains(this string _string, string _targetString, StringComparison _comparison)
        {
            return _string?.IndexOf(_targetString, _comparison) >= 0; 
        }
        ...
        public static string MultipleSpacesToSingleSpace(this string _string)
        {
            string result = _string;
            while (result.HasConsecutiveSpaces())
            {
        ...
        public static bool HasConsecutiveSpaces(this string _string)
        {
...
#pragma warning restore IDE1006 // Naming Styles
    ...
    {
        public static string Sum(this List<string> _stringList, int _startIndex) { return _stringList.Sum(_startIndex, _startIndex); }
        public static string Sum(this List<string> _stringList, int _startIndex, int _endIndex) { return _stringList.Sum(_startIndex, _endIndex, ""); }
        public static string Sum(this List<string> _stringList, int _startIndex, int _endIndex, string _separator)
        {
            if (_stringList == null
                || _stringList.Count == 0
                || _startIndex < 0
                || _startIndex > _endIndex
                || _stringList.Count - 1 < _endIndex)
            {
                return string.Empty;
            }
            ...
            {
                result += ((i != _startIndex) ? _separator : "") + _stringList[i];
            }
    ...
    public static class DictionaryExtension
    {
        ...
        public static K GetFirstKeyOrDefault<K, V>(this Dictionary<K, V> _dictionary, Func<KeyValuePair<K, V>, bool> _predicate) { return _dictionary.Any(_predicate) ? _dictionary.First(_predicate).Key : default(K); }
